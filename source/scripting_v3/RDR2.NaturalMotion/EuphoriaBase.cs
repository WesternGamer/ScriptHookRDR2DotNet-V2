...
namespace RDR2.NaturalMotion
{
	/// <summary>
	/// A base class for manually building a <see cref="RDR2.NaturalMotion.Message"/>.
	/// </summary>
	...
	/// <summary>
	/// A helper class for building a <seealso cref="RDR2.NaturalMotion.Message" /> and sending it to a given <see cref="Ped"/>.
	/// </summary>
